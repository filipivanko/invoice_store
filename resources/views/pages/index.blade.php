        ...
        <div class="page float-left " id="faktura">
          ...
          <div>
            <div class="float-left">
              <table  class="tablica_layout">
                <tbody>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Kupac:</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Adresa:</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Oib</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td"></td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td"></td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
            ...
            <div class="float-left tablica_kupac_i_podatci_odstojanje_drugi">
              <table class="tablica_layout">
                <tbody>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Br. Otpremnice:</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Datum otpreme:</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Narudžba br.</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Dospijeće:</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                  <tr>
                    <td class="tablice_kupac_i_podatci_td">Način Plaćanja</td><td class="tablice_kupac_i_podatci_td"></td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="dugi_td"><select class="select_dugi"><option> - Odaberi - </option></select></td>
                    <td class="kratki_td"><input type="text" class="input_kratki"/></td>
                    <td class="kratki_td"><input type="text" class="input_kratki"/></td>
          ...
          <div class="float-left">
            <table>
              <tbody>
                <tr>
                  <td class="iznos_slovima_prvi_red">&nbsp; Iznos slovima:</td><td class="iznos_slovima_drugi_red"></td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="donji_dio float-left">
            <div class="display-block mb-5"> 
             ...
             <div class="float-left">21/05/2018 10:00 Sati</div>			<div class="ovlastena_osoba float-left">Ovlaštena Osoba</div>
          </div>
        </div>
        </div>
